...
T = TypeVar("T", bound="FeedbackEntity")


@_attrs_define
class FeedbackEntity:
    """Feedback entity with system-generated identifier
    ...
    Attributes:
        ...
        id (Union[Unset, UUID]): Unique identifier for the feedback record
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        feedback_entity.additional_properties = d
